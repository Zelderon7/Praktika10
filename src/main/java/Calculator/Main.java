...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(realCalculate(in.nextLine()));
    }

    private static double realCalculate(String inp){
    ...
    static private String calculate(String inp) {
        ...
        if (inp.contains("("))
            a.replace(a.indexOf("("), a.indexOf(")") + 1, String.valueOf(calculate(a.substring(a.indexOf("(") + 1, a.indexOf(")")))));
